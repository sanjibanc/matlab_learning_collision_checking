...
function print_normalized_report_bisect( cumulative_cost_set, policy_set )
...
for i = 1:size(cumulative_cost_set, 1)
    cumulative_cost_set_new(i,:) = (cumulative_cost_set(i,:) - cumulative_cost_set(8,:))./cumulative_cost_set(8,:);
end

...
function [ selected_test, selected_gain, marginal_gain] = direct_drd_bern_lite(  selected_test_outcome, region_test, test_bias, test_cost, option )
...
for i = 1:length(candidate_test_set)
    ...
    for xt = [true false]
        ...
        marg = marginal_f_drd_bern_lite(  t, xt, selected_test_outcome, region_test, test_bias);
        gain = gain + prob*marg;
    end
